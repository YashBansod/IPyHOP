...
def tm_1_1(state): return [('t_a', 3, 4), ('t_a', 4, 5)]
def tm_1_2(state): return [('t_a', 3, 4), ('t_a', 4, 5), ('t_a', 5, 6)]
def tm_1_3(state): return [('t_a', 2, 4), ('t_a', 4, 5), ('t_a', 5, 6)]
...
def tm_3_1(state): return [('t_a', 6, 8), ('t_a', 7, 10)]
def tm_3_2(state): return [('t_a', 7, 9)]
